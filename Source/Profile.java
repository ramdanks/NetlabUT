...
public class Profile<T>
{
    ...
    public Profile(Metric<T> metric, String expected, String message, boolean arrayType)
    {
        this.metric = metric;
        this.expected = expected;
        this.message = message;
    }
    public Profile(Metric<T> metric, T expected, String message, boolean arrayType)
    {
        this.metric = metric;
