...
public class Logical
{
    ...
    public static <T> boolean throwing(T throwable)
    { return throwable != null && throwable instanceof Throwable; }
    public static boolean throwing(Class<?> expectedType, Throwable throwable)
